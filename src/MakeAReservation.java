...
public class MakeAReservation extends Reservation {
    ...
    public MakeAReservation(int counter, int[][] seatingPlan) {
    ...
    public void makeReservation() {
        ...
        do {
            System.out.print("Please enter the list of seats you want to reserve('ENTER' - to exit): ");
        ...
        if (trueFalse) {
            System.out.println("Successful! Reservation Confirmed");
        }
    }
    ...
    public boolean seatOccupancy(String seatNumberSelection) {
        if (seatNumberSelection.length() == 2 && asciiNumber(seatNumberSelection) - 65 <= 7) {
            if (seatingPlan[asciiNumber(seatNumberSelection) - 65][Integer.parseInt(s) - 1] == 0) {
                seatingPlan[asciiNumber(seatNumberSelection) - 65][Integer.parseInt(s) - 1] = 1;
                counter++;
                return true;
            } else {
                System.out.println("Seat " + seatNumberSelection + " is reserved already.");
                return false;
            }
